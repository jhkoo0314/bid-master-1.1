...
const getPropertySearchTerms = (propertyType: string): string[] => {
  const baseTerms: Record<string, string[]> = {
    ...
    주택: [
      ...
      "korean residential house",
      "korean house building",
      "korean house interior",
      "korean house living room",
      "korean house kitchen",
      "korean house bedroom",
      "korean house bathroom",
      "korean house entrance",
      "korean house complex",
    ],
    다가구주택: [
      "korean multi-family house",
      "korean multi-unit house",
      "korean multi-family building",
      "korean multi-unit building",
      "korean multi-family house exterior",
      "korean multi-unit house exterior",
      "korean multi-family house interior",
      "korean multi-unit house interior",
      "korean multi-family house building",
      "korean multi-unit house building",
    ],
    근린주택: [
      "korean neighborhood house",
      "korean neighborhood building",
      "korean neighborhood house exterior",
      "korean neighborhood building exterior",
      "korean neighborhood house interior",
      "korean neighborhood building interior",
      "korean neighborhood house building",
      "korean neighborhood building complex",
      "korean neighborhood house complex",
      "korean neighborhood building structure",
    ],
    도시형생활주택: [
      "korean urban living house",
      "korean urban living building",
      "korean urban living house exterior",
      "korean urban living building exterior",
      "korean urban living house interior",
      "korean urban living building interior",
      "korean urban living house building",
      "korean urban living building complex",
      "korean urban living house complex",
      "korean urban living building structure",
    ],
  };

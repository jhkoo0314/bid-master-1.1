...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 피드백 FAB */}
      <FeedbackFAB onFeedbackClick={() => setIsExpertColumnPreparing(true)} />
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-8 shadow-2xl">
            <div className="text-center">
              ...
              <div className="space-y-4">
                ...
                <button
                  onClick={() => {
                    console.log("💬 [피드백] 피드백 제출");
                    setIsExpertColumnPreparing(false);
                  }}
                  className="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-sm w-full"
                >
                  피드백 제출
                </button>
                <button
                  ...
                  className="inline-flex items-center justify-center px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-full hover:bg-gray-200 transition-all duration-200 text-sm w-full"
                >
                  취소
                </button>
              </div>

...
function generatePropertySpecificAnalysis(
  ...
  switch (propertyType) {
    ...
    case "주택":
      ...
      baseAnalysis.strategy = "거주용과 투자용 가치를 모두 고려한 균형적 입찰";
      break;
    ...
    case "다가구주택":
      ...
      baseAnalysis.strategy = "임대 수익률과 관리 부담을 고려한 현실적 입찰";
      break;

    case "근린주택":
      baseAnalysis.learningGoal =
        "근린주택의 상업+주거 복합 특성과 상권 의존성 분석";
      baseAnalysis.keyPoints = [
        "상업+주거 복합",
        "상권 의존성",
        "임대 수익",

...
- **실제 투자금액 계산**: 자기자본 + 취득비용 합계 (권리 인수, 명도비, 리모델링비, 법무비, 취득세 등)
- **매도 전까지 투입 금액 계산**: 실제 투자금액 + 이자비용 + (월지출 - 월수입) × 보유기간
- **예상 수익 및 ROI 계산**: 차익(매도가 - 매도 전까지 투입 금액 - 매도 비용) 대비 실제 투자금액 기준 투자수익률 자동 계산
- **손익분기점 분석**: 매도 전까지 투입 금액 + 매도 비용 기준 최소 매도가 계산
- **비용 구성 상세 표시**: 투자 금액 세부 항목별 분류 (이자비용, 양도세, 중개수수료 등 포함)
...
- 임차보증금 입력
- 명도비용 입력
- 세금 계산 (취득세 1%, 기타세금 0.15%)
- 은행대출 정보 입력 (대출비율, 이자율)
- 보유기간 및 월별 현금흐름 입력
- 실제 투자금액 계산 (자기자본 + 취득비용)
- 매도 전까지 투입 금액 계산 (이자비용, 현금흐름 포함)
- 차익 및 ROI 계산 (양도세, 중개수수료 포함)
- 손익분기점 분석
